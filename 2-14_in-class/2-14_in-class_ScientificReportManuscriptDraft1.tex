...
\includegraphics{2-14_in-class_ScientificReportManuscriptDraft1_files/figure-latex/plot1-1.pdf}

\begin{verbatim}
## Warning: Removed 315 rows containing non-finite values (stat_summary).
\end{verbatim}

\includegraphics{2-14_in-class_ScientificReportManuscriptDraft1_files/figure-latex/plot2-1.pdf}
